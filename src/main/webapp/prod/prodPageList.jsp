...
<%-- 								<tr onclick="javascript:userDetail('<%=user.getUserId()%>')"> --%>
						...
						<div class="text-center">
							<ul class="pagination">
								<li><a href="/prodPageList?page=1&pageSize=10" aria-label="Previous"> <span
										aria-hidden="true">&laquo;</span>
								</a></li>
								<li><a href="/prodPageList?page=1&pageSize=10"><<</a></li>
...
<!-- 									%> -->
								<li><a href="/prodPageList?page=${startIndex == 1 ? 1 : startIndex-5}&pageSize=10"><</a></li>
								
								<c:forEach begin="${startIndex }" end="${endIndex }" varStatus="status">
									<li><a href="/prodPageList?page=${status.index }&pageSize=10">${status.index }</a></li>
								</c:forEach>

								<li><a href="/prodPageList?page=${startIndex + 5 > pdCnt ? startIndex : startIndex + 5}&pageSize=10">></a></li>
								<li><a href="/prodPageList?page=${pdCnt }&pageSize=10">>></a></li>
								<li><a href="/prodPageList?page=${pdCnt }&pageSize=10"" aria-label="Next"> <span
